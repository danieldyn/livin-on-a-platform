...
- State Management: A simple set of booleans will be created to manage the application's current state (Main Menu, Story Mode, Help Mode, etc.). The `main.py` module will contain a list of all Level objects to better manage and cycle through them, also handling control changes between levels and from level to intermediary menus or the main menu. 
